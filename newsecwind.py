...
"border-radius: 20px;")
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(230, 520, 110, 50))
        font = QtGui.QFont()
        font.setFamily("MS Sans Serif")
        font.setPointSize(14)
        self.pushButton_3.setFont(font)
        self.pushButton_3.setStyleSheet("background-color: rgb(159, 165, 160);\n"
"border-radius: 20px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Write_there_a_datatime"))
        __sortingEnabled = self.listWidget.isSortingEnabled()
        self.listWidget.setSortingEnabled(False)
        item = self.listWidget.item(0)
        item.setText(_translate("MainWindow", "proverka"))
        item = self.listWidget.item(1)
        item.setText(_translate("MainWindow", "chto"))
        item = self.listWidget.item(2)
        item.setText(_translate("MainWindow", "rabotaet"))
        self.listWidget.setSortingEnabled(__sortingEnabled)
        self.button_for_adding.setText(_translate("MainWindow", "Add"))
        self.button_for_save.setText(_translate("MainWindow", "Save"))
